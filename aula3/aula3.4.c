...
int isParity(unsigned int pacote)

return pacote&4294967296; //tem o bit 1 na exata posição 31 contando de 0? aka 2³²=4294967296
}
...
int main() {
   ...
   printf("seq pac1 = %d\n",getSeq(incrSeq(pacote1)));
    ...
    printf("parity pac1 = %s\n", isParity(pacote1) ? "S" : "N");
   printf("parity pac2 = %s\n", isParity(pacote2) ? "S" : "N");
   printf("prio pac3 = %s\n", isPrio(pacote3) ? "S" : "N");
